...
function initMap() { //initation
  ...
  testLocation.addListener('click',() => { //if area clicked; marker for area appear
    allMarkers.map((cur) => { 
  ...
  // testLocation.addListener('mouseover', function(e) {
  //   e.fillColor = '#fff600';
  //   e.strokeColor = '#fff600';
  // });
  
  /* test location end */
  
  /* sets the testArea on the map */
